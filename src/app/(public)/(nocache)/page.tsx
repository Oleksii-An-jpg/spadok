...
//     https://www.instagram.com/_dana_gordienko_/
// @dana_gordienko  (телеграм)
// + Васильєва Марія
// Дизайнерка
...
//     https://www.instagram.com/visual.mria/
// @maria_vasylieva  (телеграм)
// + Поліна Воловоденко
// Дизайнерка
// @po_malyuye  (телеграм)
// + Ольга Шевчук
...
//     https://www.instagram.com/olastardust/
// @olastardust  (телеграм)
// + Ольга Хархальова
// Веб-дизайнерка
// Дослідниця візуальних мов, керамістка, старша серед трьох сестер.
//     https://www.instagram.com/olhakharkhalova/
// @unionsupport  (телеграм)
